...
class WebScraper:
    ...
    def parse_page(self, soup):
        ...
        results = []
        try:
            #/html/body/div[3]/div[2]/main/div/div/div[3]/div/div[2]/table[1]/tbody/tr[3]/td[1]/div/div/span[2]/a
            
            # 使用CSS選擇器找到指定元素
            table_body = soup.select('.name')
...
if __name__ == "__main__":
    # 使用範例
    target_url = "https://liquipedia.net/leagueoflegends/Portal:Players/China"
